...
const Sell = () => {
        ...
        <div className='bg-gradient-to-r from-teal-600 to-teal-500 h-screen'>
                        <h1 className='text-5xl font-bold p-5 mb-4 text-white'>Sell Medicine</h1>
                ...
                <button className='bg-teal-800 hover:bg-teal-700 text-white px-6 py-3 rounded-md mt-2 mb-2 text-3xl' onClick={handlerSellMedicine}>Sell</button>      
